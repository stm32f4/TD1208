...
#define LAN_RETRIES		2					/**< Number of LAN transmit retries */
#define SIGFOX_RETRIES	2					/**< Number of SIGFOX transmit retries */
#define SIGFOX_PAYLOAD_SIZE	12				/**< Maximum SIGFOX payload size */
...
void TD_USER_Setup(void)
{
    ...
    for (i = 1; i < 1000000; i++) {
    	if (TD_LAN_ReceiveFrameSync(&RX)) {
    		...
    		TD_LAN_SendFrame(LAN_RETRIES, &TX, &RX);

    	    // Release the local RF for SIGFOX transmission
    		TD_LAN_Release();
